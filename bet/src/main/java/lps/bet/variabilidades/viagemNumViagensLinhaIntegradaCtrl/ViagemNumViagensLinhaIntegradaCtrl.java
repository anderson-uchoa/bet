package lps.bet.variabilidades.viagemNumViagensLinhaIntegradaCtrl;
...
public class ViagemNumViagensLinhaIntegradaCtrl implements IProcessarViagem {
    ...
    public String verificarIntegracao(int cartaoID, int onibusID) {
        ...
        if (viagem != null) {
            ...
            //Integração
            if ((numViagem < numMaxViagens) && (interfaceLinhaIntegradaMgt.verificarLinhaIntegrada(linhaViagemID, linhaOriginalID))) {
